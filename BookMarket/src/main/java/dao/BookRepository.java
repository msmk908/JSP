...
public class BookRepository {
	...
	public BookRepository() {
		Book book1 = new Book("a1", "HTML5+CSS3", 15000);
		book1.setAuthor("황재호");
		...
		book3.setDescription("스프링은 단순히 사용 방법만 익히는 것보다 아키텍쳐를 어떻게 이해하고 설계하는지가 더 중요합니다. 예제를 복사해 붙여넣는 식으로는 실제 개발에서 스프링을 제대로 활용할 수 없습니다...");
